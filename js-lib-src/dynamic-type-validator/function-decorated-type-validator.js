...
const calculateTaxes = (baseAmmount, workedHs, extraHs) =>
  baseAmmount * workedHs + (extraHs / 2) * baseAmmount;

//Decorate business function with a dynamic type check LAYER.
const typedTaxesFn = decorate([types.NUMBER, types.NUMBER, types.NUMBER])(
  calculateTaxes
);
